...
-(void) initInsuranceData:(FMDatabase *) db {
    NSString *beijing = [NSString stringWithFormat:@"insert into Insurance_data(endowment_insurance,medical_insurance,maternity_insurance,unemployment_insurance,employment_injury_insurance,house_fund,city_name) values('%@','%@','%@','%@','%@','%@','%@')",@"{\"high_base\":25401,\"low_base\":3387,\"personal_rate\":0.08,\"company_rate\":0.19}",@"{\"high_base\":25401,\"low_base\":3387,\"company_rate\":0.1,\"personal_rate\":\"0.02+3\"}",@"{\"high_base\":25401,\"low_base\":3387,\"personal_rate\":0.002,\"company_rate\":0.008}",@"{\"high_base\":25401,\"low_base\":3387,\"personal_rate\":0,\"company_rate\":0.008}",@"{\"high_base\":25401,\"low_base\":3387,\"personal_rate\":0,\"company_rate\":0.002}",@"{\"high_base\":25401,\"low_base\":3387,\"personal_rate\":0.12,\"company_rate\":0.12}",@"北京"];
    [db executeUpdate:beijing];
    
    NSString *shanghai = [NSString stringWithFormat:@"insert into Insurance_data(endowment_insurance,medical_insurance,maternity_insurance,unemployment_insurance,employment_injury_insurance,house_fund,city_name) values('%@','%@','%@','%@','%@','%@','%@')",@"{\"high_base\":21396,\"low_base\":4279,\"personal_rate\":0.08,\"company_rate\":0.20}",@"{\"high_base\":21396,\"low_base\":4279,\"company_rate\":0.095,\"personal_rate\":\"0.02+0\"}",@"{\"high_base\":21396,\"low_base\":4279,\"personal_rate\":0,\"company_rate\":0.001}",@"{\"high_base\":21396,\"low_base\":4279,\"personal_rate\":0.005,\"company_rate\":0.005}",@"{\"high_base\":21396,\"low_base\":4279,\"personal_rate\":0,\"company_rate\":0.005}",@"{\"high_base\":42800,\"low_base\":4600,\"personal_rate\":0.07,\"company_rate\":0.07}",@"上海"];
